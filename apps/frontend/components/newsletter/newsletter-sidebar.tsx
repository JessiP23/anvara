  ...
  return (
    <aside className="relative overflow-hidden rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-6 shadow-lg">
      ...
      <div className="relative">
        {isSubscribed ? (
          <>
            <h3 className="mb-2 text-lg font-bold text-gray-900">You're All Set! 🎉</h3>
            <p className="mb-4 text-sm leading-relaxed text-gray-600">
              Thanks for subscribing! You'll receive the hottest ad placements and exclusive deals.
            </p>
            <div className="rounded-lg border border-green-200 bg-green-50 p-3 text-center">
              <p className="text-sm font-medium text-green-700">✓ Subscribed to newsletter</p>
            </div>
          </>
        ) : (
          <>
