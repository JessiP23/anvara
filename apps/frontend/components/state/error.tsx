        ...
        <div className={`flex flex-col items-center justify-center rounded-xl border border-red-200 bg-gradient-to-b from-red-50 to-white p-8 text-center ${className}`}>
            ...
            {onRetry && (
                <button
                    type="button"
                    onClick={onRetry}
                    className="mt-5 flex itmes-center gap-2 rounded-lg border border-red-300 bg-white px-5 py2 text-sm font-medium text-red-700 transition-all hover:text-red-50"
                >
                    <span>↻</span> Try Again
                </button>
            )}
