      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mb-12 flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full border border-border text-foreground transition-all duration-200 hover:bg-card disabled:opacity-25 disabled:cursor-default"
        ...
        >
          {testimonials.map((t, index) => (
            ...
            >
              {/* Quote mark */}
              <div className="mb-5 font-serif text-5xl leading-none text-[hsl(var(--accent)_/_0.2)]">
                {"\u201C"}
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[hsl(var(--accent)_/_0.1)] text-sm font-semibold text-[hsl(var(--accent))]">
                  {t.author
                    .split(" ")
                    .map((n) => n[0])
                    .join("")}
